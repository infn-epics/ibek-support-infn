...
# git clone https://oauth2:9-o1JYch2n9_uyfv5hsR@baltig.infn.it/lnf-da-control/epics-menlo-syncro.git /epics/support/${NAME} 

ibek support register ${NAME}

# declare the libs and DBDs that are required in ioc/iocApp/src/Makefile
ibek support add-libs asynInterposeMenlo 
ibek support add-dbds menlo-syncro.dbd
